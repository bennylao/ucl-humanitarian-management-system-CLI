...
class Controller:
    ...
    def admin_data_visualization(self):
        ...
        while True:
            try:
                userInput = input("Please choose one option: ")

                if userInput == 'RETURN':
                    return

                if int(userInput) not in range(1, 6):
    ...
    def volunteer_join_camp(self):
        try:
            ...
            join_info = helper.validate_join(self.user.user_id)
            if join_info is not None:
                v = Volunteer(0, self.user.username, '', '', '', '', '', '',
                              join_info, int(select_index))
                v.join_camp()
        except Exception as e:
                    ...
                    while True:
                        ...
                        if target_column_index == '1':
                            ...
                            try:
                                ...
                                res_id_arr = df_a.loc[df_a['campID'] == int(camp_id)]['resourceID'].tolist()
    ...
    def create_refugee(self):
        try:
            ...
            if user_type == 'admin':
                ...
                print("\n*The following shows the info of all available camps*\n")
            ...
            lvl = df_c.loc[df_c['campID'] == int(cid)]['healthRisk'].tolist()[0]
            ...
            if refugee_info is not None:
                ...
                r.add_refugee_from_user_input(int(cid))
            else:
                return
